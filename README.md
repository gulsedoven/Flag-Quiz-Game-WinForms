...
1.  **Refactoring:** Kodların okunabilirliğini artırmak ve yorum satırları eklemek.
2.  **Veritabanı:** Dosya sisteminden (File IO) SQL Veritabanına geçiş yapmak.
3.  **Yeni Özellikler:** Süre sayacı ve skor tablosu eklemek.
